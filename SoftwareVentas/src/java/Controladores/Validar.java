...
public class Validar extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String accion = request.getParameter("accion");//Capta lo que hay en el  boton que se llama accion 
        if (accion.equalsIgnoreCase("Ingresar")) { // si el valor del boton es Ingresar 
